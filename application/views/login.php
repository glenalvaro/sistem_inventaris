...
<div class="row justify-content-center">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <img width="30%" src="<?php echo base_url ($p->image); ?>">
                                <h5 class="text-gray-900 mb-4" style="margin-top: 10px">
                                <b style="font-size: 14pt;">HALAMAN LOGIN<br>
                                <?php echo $p->judul_app ?></b>
                                <div style="font-size: 12pt"> <?php echo $p->nama_company ?></div>
                                <div style="font-size: 11pt;"> <?php echo $p->kode_pos ?></div>
                                </h5>
                                </div>
                                <small><?= $this->session->flashdata('pesan'); ?></small>
                                <form class="user" method="post" action="<?php echo base_url('auth/aksi_login'); ?>">
    ...
    <div class="container my-auto">
                <div class="copyright text-center my-auto" style="color: #fff; font-size: 8pt">
                    <span>Copyright &copy; <?php echo date('Y'); ?> <?php echo $p->judul_app ?></span>
                </div>
            </div>
<?php }; ?>
